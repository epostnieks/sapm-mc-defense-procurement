#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Defense Procurement / Monopsony Lock-In
=======================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Defense Procurement (Monopsony Lock-In).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "defense_procurement",
    "domain_name": "Defense Procurement",
    "theorem": "Monopsony Lock-In",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 33.7,
    "channels": {
        "C1_cost_overrun_xinefficiency": {
            ...
            "high": 70.0,
            "weight": 0.3,
            "description": "Cost-plus contracting X-inefficiency: $80B raw cost growth (GAO/ICEAA 1.68\u00d7 factor on $350B base) \u00d7 0.75 attribution. RAND: 60-65% contractor-attributable. Sources: GAO-25-106402, ICEAA 2020, Arena et al. 2006."
        },
        "C2_monopoly_rent": {
            "dist": "normal",
            "low": 24.0,
            ...
            "high": 36.0,
            "weight": 0.22,
            "description": "Sole-source premium: 46% of $350B non-competitive \u00d7 22% markup \u00d7 0.85 attribution. 13\u21923 tactical missile suppliers, 8\u21923 aircraft. Stinger $25K\u2192$400K. Sources: FPDS, POGO, Quincy Institute."
        },
        "C3_opportunity_cost": {
            "dist": "normal",
            "low": 31.5,
            ...
            "high": 46.8,
            "weight": 0.2,
            "description": "Deadweight loss from C1+C2 ($43B) \u00d7 0.90 attribution \u00d7 1.2 opportunity-cost multiplier. CBO/Hamilton: infrastructure ROI 2-4\u00d7 marginal defense. Sources: Hamilton Project, CBO."
        },
        "C4_readiness_degradation": {
            ...
            "high": 21.6,
            "weight": 0.14,
            "description": "Sustainment monopoly O&S overruns ($22B on $200B O&S base, 10-15%) \u00d7 0.80 attribution. F-35 50% availability, $1.3T lifetime sustainment. Sources: DoD IG, GAO-24, NTU Foundation."
        },
        "C5_political_economy": {
            ...
            "high": 9.8,
            "weight": 0.07,
            "description": "$34B unrequested earmarks, $170M lobbying/yr (500-1200 lobbyists), 84% think-tank funding, 645 revolving-door instances/yr \u00d7 0.70 attribution. Sources: OpenSecrets, POGO, Quincy Institute, Public Citizen."
        },
        "C6_governance_institutional_failure": {
            ...
            "high": 14.3,
            "weight": 0.07,
            "description": "CR disruption ($5-8B/yr, 9/10 FYs), FAR compliance burden ($4-7B), reform-delay compounding ($3-7B) \u00d7 0.65 attribution. Section 809: 98 recs, ~24 implemented. Sources: DoD IG 2025, Section 809 Panel, GAO."
        }
    },
